...
**Generated**: 2026-01-27T13:21:08.276Z
...
| Suites Passed | 4 |
| Suites Failed | 0 |
| Total Duration | 22635ms |

## Suite Results

| Suite | Status | Duration |
|-------|--------|----------|
| Unit Tests | ✅ PASS | 439ms |
| API Tests | ✅ PASS | 3556ms |
| E2E Tests | ✅ PASS | 17905ms |
| Data Quality Tests | ✅ PASS | 735ms |
...
🌐 API Tests
  ...
  [32m✓[0m GET /api/jobs returns 200 with jobs[] and stats{} (238ms)
  [32m✓[0m Response time < 2000ms (490ms)
  [32m✓[0m Jobs have required fields (id, title, company, url, source, region) (144ms)
  [32m✓[0m Jobs limited to ≤500 (169ms)
  [32m✓[0m ?badge=Verified returns only Verified jobs (or empty) (148ms)
  [32m✓[0m ?backer=Hashed returns only Hashed-backed jobs (or empty) (163ms)
  [32m✓[0m ?badge=NonExistent returns 200 (no crash) (122ms)
  [32m✓[0m stats.sources is a non-empty array (bug fix #2) (141ms)
  [32m✓[0m ?status=all no longer exposes inactive jobs (bug fix #1) (162ms)
  [32m✓[0m 10 concurrent requests all succeed (228ms)
  [32m✓[0m GET /api/admin/jobs returns 401 without auth (204ms)
  [32m✓[0m POST /api/admin/jobs/approve returns 401 without auth (71ms)
  [32m✓[0m POST /api/admin/jobs/reject returns 401 without auth (71ms)
  [32m✓[0m POST /api/admin/jobs/delete returns 401 without auth (76ms)
  [32m✓[0m POST /api/admin/jobs/merge returns 401 without auth (72ms)
  [32m✓[0m POST /api/admin/jobs/badges returns 401 without auth (99ms)
  ...
  [32m✓[0m GET /api/admin/monitoring/errors returns 401 without auth (104ms)
  [32m✓[0m GET /api/admin/monitoring/stats returns 401 without auth (104ms)
...
🖥️  E2E Tests
  ...
  [32m✓[0m Homepage loads, shows "Web3 Jobs Platform" heading (2093ms)
  [32m✓[0m Stats cards render (Total Jobs, Global, Korea) (89ms)
  [32m✓[0m All 7 filter dropdowns/inputs present (5ms)
  [32m✓[0m Search filter: type "developer", job count changes (1469ms)
  [32m✓[0m Region filter: select Korea, jobs show Korea (853ms)
  [32m✓[0m Job Type filter: select Full-time, count changes (1039ms)
  [32m✓[0m Location filter: select Remote, count changes (970ms)
  [32m✓[0m Source filter: select web3.career, all jobs show that source (842ms)
  [32m✓[0m Badge filter: select Active, jobs have Active badge (943ms)
  [32m✓[0m Clear all resets filters (854ms)
  [32m✓[0m Filter combination: Search + Region (1069ms)
  [32m✓[0m Active filter pills appear and are removable (662ms)
  [32m✓[0m Zero results shows empty message (1364ms)
  [32m✓[0m Job card has Apply button with valid href (68ms)
  [32m✓[0m Responsive: mobile (375px) — filters stack vertically (966ms)
  [32m✓[0m Responsive: tablet (768px) — layout adapts (1005ms)
  [32m✓[0m Admin login page loads with form (1543ms)
