...
**Generated**: 2026-01-27T13:33:18.423Z
...
| Suites Passed | 4 |
| Suites Failed | 0 |
| Total Duration | 22586ms |

## Suite Results

| Suite | Status | Duration |
|-------|--------|----------|
| Unit Tests | ✅ PASS | 423ms |
| API Tests | ✅ PASS | 3330ms |
| E2E Tests | ✅ PASS | 18128ms |
| Data Quality Tests | ✅ PASS | 705ms |
...
🌐 API Tests
  ...
  [32m✓[0m GET /api/jobs returns 200 with jobs[] and stats{} (252ms)
  [32m✓[0m Response time < 2000ms (183ms)
  [32m✓[0m Jobs have required fields (id, title, company, url, source, region) (159ms)
  [32m✓[0m Jobs limited to ≤500 (167ms)
  [32m✓[0m ?badge=Verified returns only Verified jobs (or empty) (226ms)
  [32m✓[0m ?backer=Hashed returns only Hashed-backed jobs (or empty) (123ms)
  [32m✓[0m ?badge=NonExistent returns 200 (no crash) (121ms)
  [32m✓[0m stats.sources is a non-empty array (bug fix #2) (125ms)
  [32m✓[0m ?status=all no longer exposes inactive jobs (bug fix #1) (152ms)
  [32m✓[0m 10 concurrent requests all succeed (294ms)
  [32m✓[0m GET /api/admin/jobs returns 401 without auth (180ms)
  [32m✓[0m POST /api/admin/jobs/approve returns 401 without auth (78ms)
  [32m✓[0m POST /api/admin/jobs/reject returns 401 without auth (86ms)
  [32m✓[0m POST /api/admin/jobs/delete returns 401 without auth (80ms)
  [32m✓[0m POST /api/admin/jobs/merge returns 401 without auth (71ms)
  [32m✓[0m POST /api/admin/jobs/badges returns 401 without auth (101ms)
  [32m✓[0m GET /api/admin/jobs/duplicates returns 401 without auth (94ms)
  [32m✓[0m GET /api/admin/monitoring/crawl-history returns 401 without auth (97ms)
  [32m✓[0m GET /api/admin/monitoring/proxies returns 401 without auth (99ms)
  [32m✓[0m GET /api/admin/monitoring/errors returns 401 without auth (103ms)
  [32m✓[0m GET /api/admin/monitoring/stats returns 401 without auth (100ms)
  [32m✓[0m GET /api/admin/analytics/searches returns 401 without auth (109ms)
...
🖥️  E2E Tests
  ...
  [32m✓[0m Homepage loads, shows "Web3 Jobs Platform" heading (2135ms)
  [32m✓[0m Stats cards render (Total Jobs, Global, Korea) (92ms)
  [32m✓[0m All 7 filter dropdowns/inputs present (5ms)
  [32m✓[0m Search filter: type "developer", job count changes (1485ms)
  [32m✓[0m Region filter: select Korea, jobs show Korea (875ms)
  [32m✓[0m Job Type filter: select Full-time, count changes (1093ms)
  [32m✓[0m Location filter: select Remote, count changes (994ms)
  [32m✓[0m Source filter: select web3.career, all jobs show that source (849ms)
  [32m✓[0m Badge filter: select Active, jobs have Active badge (953ms)
  [32m✓[0m Clear all resets filters (879ms)
  [32m✓[0m Filter combination: Search + Region (1103ms)
  [32m✓[0m Active filter pills appear and are removable (672ms)
  [32m✓[0m Zero results shows empty message (1401ms)
  [32m✓[0m Job card has Apply button with valid href (85ms)
  [32m✓[0m Responsive: mobile (375px) — filters stack vertically (995ms)
  [32m✓[0m Responsive: tablet (768px) — layout adapts (988ms)
  [32m✓[0m Admin login page loads with form (1538ms)
...
📊 Data Quality Tests
  ...
  [32m✓[0m All badge values are from known set (1ms)
