        ...
        <div className="lg:col-span-8">
          <div className="border border-a24-border dark:border-a24-dark-border rounded overflow-hidden">
            ...
            <div className="overflow-x-auto">
              {/* Column headers */}
              <div className="grid grid-cols-[minmax(120px,1fr)_repeat(4,72px)] sm:grid-cols-[minmax(140px,1fr)_repeat(4,80px)] px-3 py-2 border-b border-a24-border/30 dark:border-a24-dark-border/30">
                <span />
                {LEVELS.map(level => (
                  <span
                    key={level}
                ...
                {role.skillLevelMatrix.length > 0 ? (
                  role.skillLevelMatrix.map((entry, i) => (
                    <motion.div
                      ...
                      className="grid grid-cols-[minmax(120px,1fr)_repeat(4,72px)] sm:grid-cols-[minmax(140px,1fr)_repeat(4,80px)] px-3 group hover:bg-a24-surface/30 dark:hover:bg-a24-dark-surface/30 transition-colors"
                    >
                      {/* Skill name */}
