    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <main className="max-w-6xl mx-auto px-6 pb-20">
        ...
        <div className="py-12 border-b border-gray-800 mb-8">
          ...
          <div className="flex items-center gap-4 mt-6">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-gray-800 hover:bg-gray-700 text-white font-medium transition-colors"
            >
        ...
        {showLeaderboard && (
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-bold text-white">Top Bounty Hunters</h3>
            </div>
            ...
            {leaderboard.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                {leaderboard.slice(0, 5).map((hunter, idx) => (
                  <div
                    key={hunter.id}
                    className={`p-4 border ${idx === 0 ? 'border-yellow-500/50 bg-yellow-500/5' : 'border-gray-800'}`}
                  >
              ...
              <p className="text-gray-500 text-sm">No hunters yet. Be the first!</p>
            )}
          </motion.div>
        )}
        ...
        {loading ? (
          ...
          <div className="py-20 text-center border border-gray-800">
            <Pixelbara pose="question" size={120} className="mx-auto mb-4" />
            <p className="text-lg text-white mb-2">No bounties found</p>
            ...
            {bounties.map((bounty, idx) => (
              ...
              >
                <Link
                  ...
                  className="block p-6 bg-gray-900/50 border border-gray-800 hover:border-green-500/50 transition-colors group"
                >
                      ...
                      {bounty.skills && bounty.skills.length > 0 && (
                        <div className="flex flex-wrap gap-1.5 mb-3">
                          {bounty.skills.slice(0, 4).map(skill => (
                            <span
                              key={skill}
                              className="px-2 py-0.5 bg-gray-800 text-gray-400 text-xs"
                            >
                              {skill}
                            </span>
                          ))}
        ...
        {/* Stats Banner */}
        <div className="mt-12 grid grid-cols-3 gap-4 p-6 bg-gray-900/30 border border-gray-800">
          <div className="text-center">
            <p className="text-2xl font-bold text-white">{bounties.length}</p>
            <p className="text-xs text-gray-500 uppercase tracking-wider">Active Bounties</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500 uppercase tracking-wider">Active Hunters</p>
          </div>
        </div>
      </main>
