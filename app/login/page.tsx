    ...
    <div className="min-h-screen bg-a24-bg dark:bg-a24-dark-bg">
      <main className="max-w-md mx-auto px-6 py-20 md:py-32">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3.5 bg-white text-gray-800 text-sm font-medium rounded-none hover:bg-gray-100 transition-colors border border-gray-300"
        >
